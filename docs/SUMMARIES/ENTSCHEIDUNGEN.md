...
source_hash: 66cd59f6bc8cd1acdf778bf19f4a7f36e3dd046f6999878ae25cb13880872153
...
- **„Konvenient vor traditionell"** als Daily-Driver-Default (Side-by-Side-Markdown statt versteckter Drittwahl, Auto-Update als Banner statt Settings-only).
...
## Aktuelle Entscheidungen (Season 24–28)
...
- **GitHub-Actions Full-Pipeline (B):** Workflow legt Release-Objekt selbst an (idempotent), Pre-Release-Flag aus Tag-Suffix (`-alpha`/`-beta`/`-rc`). A (Minimal/Upload-only) loescht nur halbe Reibungspunkt; C (Matrix fuer macOS/Linux) Over-Engineering ohne Roadmap-Trigger.
- **Auto-Update electron-updater + Forge/Squirrel (A):** Roadmap-Wortlaut woertlich erfuellt, kein Build-Stack-Bruch. B (electron-builder) wuerde Forge-Externals-Falle in andere Richtung neu freilegen. C (`update.electronjs.org`) verschenkt UX-Kontrolle.
